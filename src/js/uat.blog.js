// RELEASE: 20210731.1330

var blogTitle = 'iCapito.it';
var siteUrl = 'http://localhost/old';
var databaseUrl = 'http://localhost/db';
var minWidth = 800;
var disqusEnabled = false;
var disqusVisible = false;
var googleAnalytics = false;
var enableCookie = false;

var objects = {
    "article" : ["title","description","content","tag","category"],
    "list" : ["title","description","readmore:false"],
    "page" : ["title","content"],
    "home" : ["title","content"],
};
            ...
            if ($type.startsWith('list:')) {
                ...
                if ($body.length) {
                    ...
                    for (i=1;i<=$counter;i++) {
                        ...
                        objects[$realtype].forEach(function(elementraw) {
                            element=elementraw;
                            toconvert=true;
                ...
                if ($body.length) {
                    ...
                    objects[$type].forEach(function(elementraw) {
                        element=elementraw;
                        toconvert=true;
                        $typeelem = elementraw.split(':');
                        if ($typeelem.length > 1) {
